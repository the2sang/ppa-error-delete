...
public class TaxEmailBillInfoRowMapper implements RowMapper<TaxEmailBillInfoVO> {

    @Override
    public TaxEmailBillInfoVO mapRow(ResultSet resultSet, int rowNum) throws SQLException {
        return new TaxEmailBillInfoVO(
