...
public class IfTaxBillInfoRowMapper implements RowMapper<IfTaxBillInfoVO> {

    @Override
    public IfTaxBillInfoVO mapRow(ResultSet resultSet, int rowNum) throws SQLException {
        return new IfTaxBillInfoVO(
